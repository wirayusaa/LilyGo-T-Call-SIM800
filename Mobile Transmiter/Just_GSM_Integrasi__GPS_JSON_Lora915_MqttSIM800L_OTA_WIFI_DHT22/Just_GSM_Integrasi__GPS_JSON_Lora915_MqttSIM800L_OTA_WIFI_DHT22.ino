...
void SensorSetup()
{
  ...
  dht.begin();  //sensor suhu dan kelembapan 1
}
//========================================================================================
void setup()
{
...
Serial.print("DigitalLevel1    :");
Serial.println(DigitalLevel1);
ValueLevel1= (((DigitalLevel1*3.3/4096)/Resistor1)-0.004)*MaxSensorLevel1/16;
Serial.print("ValueLevel1    :");
Serial.println(ValueLevel1);
...
// Serial.println(jsonnodeGSM800String);
 Serial.println();
 delay(100);
...
// GpsLoop();
 JsonLoop();
 if(ValueTemperatur1>=28 || ValueHumidity1 => 70 ){
  {
    MqttSIM800loop();
    delay(100);
  }
...
// LoraLoop();
 MqttSIM800loop();
 Serial.println("GSM Send Data Via MQTT Protocol ");
 }
 delay(1000);
}
